...
if(mouse_check_button(mb_left) && self.pickedUp == true && instance_exists(player))
{
	if(!doFire && !instance_exists(obj_FireCharge))
	{
		instance_create_layer(player.x, player.y, "Instances", obj_FireCharge);
	}
	else if(doFire)
	{
